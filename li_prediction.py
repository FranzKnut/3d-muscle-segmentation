...
x_input_1 = MircInput(
    ["OP"], output_shapes=[(1, None, None, None, 1)], name="OP_input", n=None
)
x_input_2 = MircInput(["IP"], output_shapes=[(1, None, None, None, 1)], name="IP_input")
mask_input = MircInput(
    ["Mask"], output_shapes=[(1, None, None, None, 1)], name="mask_input"
)
...
for p in cases:
    ...
    if len(output_dirs) != 0:
        dvn_model.predict(
            "li_pred", sampler, output_dirs=output_dirs, return_predictions=False
        )

...
model = create_generalized_unet_model(
    ...
    subsample_factors_per_pathway=((1, 1, 1), (3, 3, 3), (9, 9, 9), (27, 27, 27)),
...
x_input_1 = MircInput(
    ["OP"],
    output_shapes=[(1, None, None, None, 1)],
    name="OP_input",
    n=None,
)
...
# x_input_1 = GridCrop(mask_input, split_size, n=2)(x_input_1)
# x_input_2 = GridCrop(mask_input, split_size, n=2)(x_input_2)
# mask_input = GridCrop(mask_input, split_size, n=2)(mask_input)
...
for p in cases:
    ...
    if len(output_dirs) != 0:
        dvn_model.predict(
            "hi_pred", sampler, output_dirs=output_dirs, return_predictions=False
        )
